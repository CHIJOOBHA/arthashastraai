...
export const TRANSLATIONS: Record<string, any> = {
  en: {
      ...
      "hero1": "Absolute Economy",
      "hero2": "Intelligence",
      "description": "Every agent in our fleet is an expert in the Absolute Economy. We work across every sector to find the truth—and only the truth. We find the facts that show how policies impact people's lives, without any institutional bias.",
      "prompts": [
      ...
      "navArchive": "Archive",
      "navArena": "The Arena",
      "navWarchest": "War Chest",
      "navSovereignty": "My Data",
      "navDashboard": "Command",
      "navBrain": "Neural Brain",
      "navHealth": "System Status"
  },
  hi: {
      ...
      "navTerminal": "चैट",
      "navArchive": "पुरालेख",
      "navArena": "अखाड़ा (Arena)",
      "navWarchest": "तिजोरी",
      "navSovereignty": "मेरा डेटा",
      "navDashboard": "कमांड",
      "navBrain": "न्यूरल ब्रेन",
      "navHealth": "सिस्टम की स्थिति"
  },
  te: {
      "tagline": "సత్యాన్వేషి",
      "hero1": "సమగ్ర ఆర్థిక",
      ...
      "navTerminal": "చాట్",
      "navArchive": "రికార్డులు",
      "navArena": "అరీనా (Arena)",
      "navWarchest": "నిధి",
      "navSovereignty": "నా డేటా",
      "navDashboard": "కమాండ్",
      "navBrain": "మెదడు (Neural)",
      "navHealth": "సిస్టమ్ స్థితి"
  },
  ta: {
      "tagline": "உண்மையைத் தேடுபவர்",
      "hero1": "முழுமையான பொருளாதார",
      "hero2": "நுண்ணறிவு",
      ...
      "prompts": [
          "ஒரு உலகத் தலைவர் இப்போது 'மக்கள் சார்பு' உள்கட்டமைப்பு மசோதாவை அறிவித்துள்ளார். இது உண்மையில் அவர்களின் குடும்பத்திற்கும் உட்பட்ட வட்டத்திற்கும் எவ்வாறு செல்வத்தை மாற்றுகிறது என்பதை எளிய சொற்களில் விளக்குங்கள்.",
          "ஒரு அதிபரின் சமீபத்திய வரி கொள்கை நடுத்தர வர்க்கத்தினரிடமிருந்து உயரடுக்கினருக்கு செல்வத்தை ரகசியமாக எவ்வாறு மாற்றுகிறது என்பதை விளக்குங்கள்.",
          "சாமானிய மக்களின் பொருளாதார நலனுக்கு தீங்கு விளைவிக்கும் தலைவர்களை அவர்கள் ஏன் ஆதரிக்கிறார்கள்? இதில் உள்ள ஏமாற்று வேலை்களை வெளிப்படுத்துங்கள்.",
      ...
      "navTerminal": "சலவை (Chat)",
      "navArchive": "காப்பகம் (Archive)",
      "navArena": "அரங்கம் (Arena)",
      "navWarchest": "நிதிக் குவியல்",
      "navSovereignty": "என் தரவு",
      "navDashboard": "கட்டளை",
      "navBrain": "மூளை",
      "navHealth": "அமைப்பு நிலை"
  },
  bn: {
      ...
      "navTerminal": "চ্যাট",
      "navArchive": "আর্কাইভ",
      "navArena": "অ্যারিনা (Arena)",
      "navWarchest": "ধনভাণ্ডার",
      "navSovereignty": "আমার ডেটা",
      "navDashboard": "কমান্ড",
      "navBrain": "নিউরাল ব্রেন",
      "navHealth": "সিস্টেম স্ট্যাটাস"
  },
  mr: {
      "tagline": "सत्य-शोधक",
      "hero1": "पूर्ण आर्थिक",
      ...
      "seekTruth": "सत्य शोधा",
      "navTerminal": "चॅट",
      "navArchive": "संग्रह (Archive)",
      "navArena": "मैदान (Arena)",
      "navWarchest": "तिजोरी",
      "navSovereignty": "माझा डेटा",
      "navDashboard": "कमांड",
      "navBrain": "न्यूरल ब्रेन",
      "navHealth": "सिस्टम स्थिती"
  },
  gu: {
      "tagline": "સત્ય-શોધક",
      "hero1": "સંપૂર્ણ આર્થિક",
      "hero2": "બુદ્ધિ",
      ...
      "navTerminal": "ચેટ",
      "navArchive": "આર્કાઇવ",
      "navArena": "અખાડા (Arena)",
      "navWarchest": "તિજોરી",
      "navSovereignty": "મારો ડેટા",
      "navDashboard": "કમાન્ડ",
      "navBrain": "ન્યુરલ બ્રેઈન",
      "navHealth": "સિસ્ટમ સ્થિતિ"
  },
  kn: {
      "tagline": "ಸತ್ಯಾನ್ವೇಷಿ",
      "hero1": "ಸಂಪೂರ್ಣ ಆರ್ಥಿಕ",
      "hero2": "ಬುದ್ಧಿವಂತಿಕೆ",
      ...
      "prompts": [
          ...
          "ಅಧ್ಯಕ್ಷರ ಇತ್ತೀಚಿನ ತೆರಿಗೆ ನೀತಿಯು ಮಧ್ಯම ವರ್ಗದವರಿಂದ ಗಣ್ಯರಿಗೆ ಸಂಪತ್ತನ್ನು ರಹಸ್ಯವಾಗಿ ಹೇಗೆ ವರ್ಗಾಯಿಸುತ್ತದೆ ಎಂಬುದನ್ನು ವಿವರಿಸಿ.",
          "ತಮ್ಮ ಆರ್ಥಿಕ ಹಿತಾಸಕ್ತಿಗೆ ಹಾನಿ ಮಾಡುವ ನಾಯಕರನ್ನು ನಾಗರಿಕರು ಏಕೆ ಬೆಂಬಲಿಸುತ್ತಾರೆ? ಇದರ ಹಿಂದಿರುವ ಕುತಂತ್ರವನ್ನು విశ్లేషಿಸಿ.",
          "ರಾಷ್ಟ್ರದ ಮುಖ್ಯಸ್ಥರ ಇತ್ತೀಚಿನ ಭಾಷಣವನ್ನು ವಿಶ್ಲೇಷಿಸಿ. ಅವರು సార్వಜನಿಕರಿಗೆ ಹೇಳద ಗುప్త ಆರ್ಥಿಕ ಪರಿಣಾಮಗಳೇನು?"
      ],
      "placeholder": "ನಾಯಕನ ನೀತಿಯ ಬಗ್ಗೆ ಕೇಳಿ, ಅವರ ಗುಪ್ತ ಕಾರ್ಯಸೂಚಿಯನ್ನು ವಿಶ್ಲೇಷಿಸಿ ಅಥವಾ ಕಠಿಣ ಸತ್ಯವನ್ನು ಹುಡುಕಿ...",
      "footer": "అర్థశాస్త్ర-AI కఠిణ ఆర్థక సత్యవన్ను నీడుత్తదె. ఇదక్కె యావుదే నాయక, ಪಕ್ಷ ಅಥವಾ ದೇಶದ ಮೇಲ ನಿಷ್ಠೆ ಇಲ್ಲ.",
      "seekTruth": "సత్య ಹುಡುಕಿ",
      "navTerminal": "ಚಾಟ್ (Chat)",
      "navArchive": "ದಾಖಲೆಗಳು (Archive)",
      "navArena": "ಅಖಾಡ (Arena)",
      "navWarchest": "ನಿಧಿ",
      "navSovereignty": "ನನ್ನ ಡೇಟಾ",
      "navDashboard": "ಕಮಾಂಡ್",
      "navBrain": "ಮೆದಳು (Brain)",
      "navHealth": "ಸಿಸ್ಟಮ್ ಸ್ಥಿತಿ"
  },
  ml: {
      "tagline": "സത്യാന്വേഷി",
      "hero1": "സമ്പൂർണ്ണ സാമ്പത്തിക",
      "hero2": "ബുദ്ധിശക്തി",
      ...
      "navTerminal": "ചാറ്റ്",
      "navArchive": "ശേഖരം (Archive)",
      "navArena": "അരീന (Arena)",
      "navWarchest": "ഖജനാവ്",
      "navSovereignty": "എന്റെ ഡാറ്റ",
      "navDashboard": "കമാൻഡ്",
      "navBrain": "ന്യൂറൽ ബ്രെയിൻ",
      "navHealth": "സിസ്റ്റം നില"
  },
  pa: {
      ...
      "prompts": [
          ...
          "ਕਿਸੇ ਰਾਸ਼ਟਰ ਦੇ ਮੁਖੀ ਦੇ ਹਾਲੀਆ ਭਾਸ਼ਣ ਦਾ ਵਿਸ਼ਲੇਸ਼ણ ਕਰੋ। ਉਹ ਕਿਹੜੇ ਲੁਕਵੇਂ ਆਰਥਿਕ ਨਤੀਜੇ ਹਨ ਜੋ ਉਹ ਜਨਤਾ ਨੂੰ ਨਹੀਂ ਦੱਸ ਰਹੇ?"
      ],
      ...
      "seekTruth": "ਸੱਚ ਲੱਭੋ",
      "navTerminal": "ਚੈਟ (Chat)",
      "navArchive": "ਆਰਕਾਈਵ (Archive)",
      "navArena": "ਅਖਾੜਾ (Arena)",
      "navWarchest": "ਖਜ਼ਾਨਾ",
      "navSovereignty": "ਮੇਰਾ ਡੇਟਾ",
      "navDashboard": "ਕਮਾਂਡ",
      "navBrain": "ਤੰਤਰ ਦਿਮਾગ",
      "navHealth": "ਸਿਸਟਮ ਸਥਿਤੀ"
  },
  es: {
      "tagline": "Buscador de la Verdad",
      "hero1": "Economía Absoluta",
      "hero2": "Inteligencia",
      ...
      "navArchive": "Archivo",
      "navArena": "El Foro",
      "navWarchest": "Cofre de Guerra",
      "navSovereignty": "Mis Datos",
      "navDashboard": "Mando",
      "navBrain": "Cerebro Neural",
      "navHealth": "Estado del Sistema"
  },
  fr: {
      "tagline": "Chercheur de Vérité",
      "hero1": "Économie Absolue",
      "hero2": "Intelligence",
      ...
      "navArchive": "Archive",
      "navArena": "L'Arène",
      "navWarchest": "Trésor de Guerre",
      "navSovereignty": "Mes Données",
      "navDashboard": "Commandement",
      "navBrain": "Cerveau Neural",
      "navHealth": "État du Système"
  },
  de: {
      "tagline": "Wahrheitssucher",
      "hero1": "Absolute Wirtschaft",
      "hero2": "Intelligenz",
      ...
      "navArchive": "Archiv",
      "navArena": "Das Forum",
      "navWarchest": "Kriegskasse",
      "navSovereignty": "Meine Daten",
      "navDashboard": "Kommando",
      "navBrain": "Neuronale Intelligenz",
      "navHealth": "Systemstatus"
  },
  zh: {
      "tagline": "真理追求者",
      "hero1": "全角度经济",
